...
public class Application {
     ...
     * --source-conf s1-username=m
     * --source-conf s1-password=L
     * --source-conf s1-hostname=
     * --source-conf s1-port=
     * --source-conf s1-database=cdc
     * --source-conf s1-tables=cdc.biz_keeper_grade,cdc.biz_bus_opp

     * --source-conf s2-username=
     * --source-conf s2-password=
     * --source-conf s2-hostname=
     * --source-conf s2-port=
     ...
     * --sink-conf url=jdbc:mysql:///widetabledb?useSSL=false&useUnicode=true&characterEncoding=UTF-8
